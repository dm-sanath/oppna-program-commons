...
public interface OrganizationHelper {
    ...
    Organization createIfNeeded(String organizationName, Organization parent, long companyId);

    Organization createIfNeeded(String organizationName, long companyId);
